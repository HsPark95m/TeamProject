...
//	(@RequestParam("searchTag")String searchTag, @RequestParam("searchWord")String searchWord, @RequestParam("del")boolean d)
//	{
...
//	}
	...
	@RequestMapping("/getAllPostList")
	public ArrayList<CompanyBoardDto> getAllPostList
	(@RequestParam("searchTag")String searchTag, @RequestParam("searchWord")String searchWord, @RequestParam("del")boolean d, @RequestParam("searchCategory")String searchCategory)
	{
	...
	public Map<String, List<CompanyBoardDto>> getNoticeAndPopularPosts() {
	    // 공지 글 3개
	    List<CompanyBoardDto> noticePosts = service.getTopNoticePosts(3);
	    // 인기 글 5개
	    List<CompanyBoardDto> popularPosts = service.getTopPopularPosts(5);
